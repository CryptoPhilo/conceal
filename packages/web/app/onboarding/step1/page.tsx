    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-950 text-white px-4 py-12">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-bold">이메일 계정을 연결해 주세요</h1>
          <p className="text-gray-400 text-sm">🔒 읽기 전용 권한만 요청합니다</p>
        </div>
        ...
        {!showImap ? (
          <div className="space-y-3">
            <button
              ...
              disabled={!!loading}
              className="w-full flex items-center justify-center gap-3 py-3 px-6 bg-white hover:bg-gray-100 text-gray-900 rounded-xl font-semibold transition-colors disabled:opacity-50"
            >
              ...
              {loading === 'gmail' ? '연결 중...' : 'Google (Gmail)로 계속'}
            </button>
          ...
          <form onSubmit={handleImap} className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-gray-400 mb-1">앱 비밀번호</label>
              <input
                type="password"
                required
                value={imap.password}
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-sm text-gray-400 mb-1">IMAP 서버 (선택)</label>
                <input
                  type="text"
                  value={imap.host}
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-1">포트 (선택)</label>
                <input
                  type="number"
                  value={imap.port}
